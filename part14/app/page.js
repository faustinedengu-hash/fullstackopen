...
import { getLiveTopics } from "@/services/topics"
import TopicForm from "./TopicForm" // <-- NEW: Imported our validated client form element
...
export default async function Home() {
  ...
  return (
    <div className="p-8 max-w-xl mx-auto font-sans">
      ...
      {/* NEW: Extracted form managing server-side state validations */}
      <TopicForm />
